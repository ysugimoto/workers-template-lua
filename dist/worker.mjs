...
// wasm-binary:/Users/sugimoto/github/workers-template-lua/build/module.wasm
...
// wasm-stub:/Users/sugimoto/github/workers-template-lua/build/module.wasm
var module_default2 = (imports) => module_default;
...
var emscripten_module = new Promise((resolve, reject) => {
  (0, import_module3.default)({
    instantiateWasm(info, receive) {
      const instance = new WebAssembly.Instance(module_default2, info);
      receive(instance);
